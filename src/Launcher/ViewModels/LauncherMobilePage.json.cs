...
namespace Launcher {
    ...
    [LauncherMobilePage_json]                                       // This attribute tells Starcounter that the class corresponds to an object in the JSON-by-example file.
    partial class LauncherMobilePage : Page {
        [LauncherMobilePage_json.searchBar]
